...
//funzioni aggiunte per generare numeri pseudocasuali con distribuzione esponenziale e lorentziana
double Random:: Exp(double lambda) {
	
	//estratto un numero casuale tra 0 e 1, 1 escluso
	double y = Rannyu();
	
	//calcolato un numero casuale, legato a y, tramite inversione della funzione integrale
...
double Random:: CauchyLorentz(double mean, double gamma) {
	...
	//calcolato un numero casuale, legato a y, tramite inversione della funzione integrale
	double x = gamma*tan( M_PI*( y - 0.5 ) ) + mean;
