...
public:
  ...
  //Method to generate a randum number with an exponential distribution
	double Exp(double);
	//Method to generate a randum number with a Cauchy-Lorentz distribution
	double CauchyLorentz(double, double);
};
