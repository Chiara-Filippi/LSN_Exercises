...
int n_props, iv, ik, it, ie, iw, ipr;
...
double stima_pot, stima_kin, stima_etot, stima_temp, stima_pr, stima_gr;
double err_pot, err_kin, err_etot, err_temp, err_gdir, err_pr, err_gr;
double norm;
